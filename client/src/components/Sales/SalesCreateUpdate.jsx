...
import {CreateSaleRequest, CustomerDropDownRequest, ProductDropDownRequest} from "../../APIRequest/SaleAPI";
import {useSelector} from "react-redux";
import store from "../../redux/store/store";
import {OnChangeSaleInput, RemoveSaleItem, SetSaleItemList} from "../../redux/state-slice/sale-slice";
import {useNavigate} from "react-router-dom";
import {ErrorToast, IsEmpty} from "../../helper/FromHelper";
...
const SalesCreateUpdate = () => {
    ...
    const OnAddCart = () => {
        ...
        let productName = productRef.value;
